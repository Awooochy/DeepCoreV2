...
namespace DeepClient.Client.GUI
{
    internal class GUIStyle
    {
        public static void RenderMenu()
        {
            ...
            style.WindowPadding = new Vector2(5.5f, 8.300000190734863f);
            ...
            style.Colors[(int)ImGuiCol.FrameBg] = new Vector4(0.1372549086809158f, 0.1725490242242813f, 0.2274509817361832f, 0.5400000214576721f);
            style.Colors[(int)ImGuiCol.FrameBgHovered] = new Vector4(0.2117647081613541f, 0.2549019753932953f, 0.3019607961177826f, 0.4000000059604645f);
            style.Colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.04313725605607033f, 0.0470588244497776f, 0.0470588244497776f, 0.6700000166893005f);
            style.Colors[(int)ImGuiCol.TitleBg] = new Vector4(0.03921568766236305f, 0.03921568766236305f, 0.03921568766236305f, 1.0f);
            style.Colors[(int)ImGuiCol.TitleBgActive] = new Vector4(0.0784313753247261f, 0.08235294371843338f, 0.09019608050584793f, 1.0f);
            ...
            style.Colors[(int)ImGuiCol.CheckMark] = new Vector4(0.7176470756530762f, 0.7843137383460999f, 0.843137264251709f, 1.0f);
            style.Colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.47843137383461f, 0.5254902243614197f, 0.572549045085907f, 1.0f);
            style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.2901960909366608f, 0.3176470696926117f, 0.3529411852359772f, 1.0f);
            style.Colors[(int)ImGuiCol.Button] = new Vector4(0.1490196138620377f, 0.1607843190431595f, 0.1764705926179886f, 0.4000000059604645f);
            style.Colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.1372549086809158f, 0.1450980454683304f, 0.1568627506494522f, 1.0f);
            style.Colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.0784313753247261f, 0.08627451211214066f, 0.09019608050584793f, 1.0f);
            style.Colors[(int)ImGuiCol.Header] = new Vector4(0.196078434586525f, 0.2156862765550613f, 0.239215686917305f, 0.3100000023841858f);
            style.Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.1647058874368668f, 0.1764705926179886f, 0.1921568661928177f, 0.800000011920929f);
            style.Colors[(int)ImGuiCol.HeaderActive] = new Vector4(0.07450980693101883f, 0.08235294371843338f, 0.09019608050584793f, 1.0f);
            style.Colors[(int)ImGuiCol.Separator] = new Vector4(0.4274509847164154f, 0.4274509847164154f, 0.4980392158031464f, 0.5f);
            style.Colors[(int)ImGuiCol.SeparatorHovered] = new Vector4(0.239215686917305f, 0.3254902064800262f, 0.4235294163227081f, 0.7799999713897705f);
            style.Colors[(int)ImGuiCol.SeparatorActive] = new Vector4(0.2745098173618317f, 0.3803921639919281f, 0.4980392158031464f, 1.0f);
            style.Colors[(int)ImGuiCol.ResizeGrip] = new Vector4(0.2901960909366608f, 0.3294117748737335f, 0.3764705955982208f, 0.2000000029802322f);
            style.Colors[(int)ImGuiCol.ResizeGripHovered] = new Vector4(0.239215686917305f, 0.2980392277240753f, 0.3686274588108063f, 0.6700000166893005f);
            style.Colors[(int)ImGuiCol.ResizeGripActive] = new Vector4(0.1647058874368668f, 0.1764705926179886f, 0.1882352977991104f, 0.949999988079071f);
            style.Colors[(int)ImGuiCol.Tab] = new Vector4(0.1176470592617989f, 0.125490203499794f, 0.1333333402872086f, 0.8619999885559082f);
            style.Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.3294117748737335f, 0.407843142747879f, 0.501960813999176f, 0.800000011920929f);
            style.Colors[(int)ImGuiCol.TabActive] = new Vector4(0.2431372553110123f, 0.2470588237047195f, 0.2549019753932953f, 1.0f);
